...
A simple and mininal static site generator with no extenal dependencies.  
The only dependency is TypeScript for running the application.  
Build, run and testing are all done without using other libraries.
...
## TODO
- [ ] Move index file to the layouts
